    ...
    <div className="pb-16">
      ...
      <section className="section-glow-top relative w-full flex items-center overflow-hidden">
        ...
        <img
          ...
          className="absolute inset-0 md:inset-x-0 md:top-[12%] md:bottom-[12%] w-full h-full md:h-auto object-cover md:object-contain object-[50%_55%] sm:object-[50%_45%] md:object-[center_15%]"
          loading="lazy"
        />
        <div className="absolute inset-0 bg-black/42" />
