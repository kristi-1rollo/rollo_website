  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-y-0 left-0 md:hidden w-full bg-[linear-gradient(90deg,rgba(2,6,13,0.6)_0%,rgba(2,6,13,0.35)_35%,rgba(2,6,13,0.1)_70%,rgba(2,6,13,0)_100%)]" />
