...
export const PUBLIC_SECTION_GUTTER = "px-4 sm:px-6 lg:px-20";
export const PUBLIC_CONTENT_RAIL = `max-w-6xl lg:max-w-[1440px] mx-auto ${PUBLIC_SECTION_GUTTER} text-left`;
